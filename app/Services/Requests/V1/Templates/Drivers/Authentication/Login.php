...
class Login extends Templatable
{
    ...
    public function __construct(Driver $driver)
    {
        ...
        $this->setQuery([
            'action' => 'login',
            'login' => $driver->getLoginUsername(),
            'password' => $driver->getLoginPassword(),
            'imsi' => $driver->getImsi(),
            'version' => config('services.requests.v1.api.defaults.mobile_version')
        ]);
    }
