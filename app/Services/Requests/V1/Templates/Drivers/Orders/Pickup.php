...
class Pickup extends Templatable
{
    //lng=23.3214088&accuracy=9.25&lon=23.3214088&imsi=1652973814&jobid=16719760&offline=0&status_id=3&gps_timestamp=2022-06-16 18:37:20&action=changePoiStatus&compliance_type=Pin&time=2022-06-16 15:37:23&poi_id=12930194&time_delta=1727&lat=42.623532&inprogress_today_orders_counter=0
    ...
    public function __construct(Driver $driver)
    {
        ...
        $this->setQuery([
            ...
            'poi_id' => $driver->getOrder()->getPoi()->getPoiId(),
            'time_delta' => 1727,
